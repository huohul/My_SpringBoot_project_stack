...
@EnableJpaRepositories(
        ...
        // 实体管理bean名称 主要实体管理器工厂
        entityManagerFactoryRef = "primaryEntityManagerFactory",
        // 事务管理bean名称
        transactionManagerRef = "primaryTransactionManager")
public class PrimaryJpaConfig {

        static final String REPOSITORY_PACKAGE = "com.gxweb.repository.primary";  //持久层
    private static final String ENTITY_PACKAGE = "com.gxweb.entity.primary";  //实体路径
