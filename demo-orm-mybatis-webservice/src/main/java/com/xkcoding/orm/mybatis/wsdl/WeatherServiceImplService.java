 ...
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://service.mybatis.orm.xkcoding.com/", wsdlLocation = "http://localhost/weather?WSDL")
public class WeatherServiceImplService
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://service.mybatis.orm.xkcoding.com/", "WeatherServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost/weather?WSDL");
    ...
    /**
     * @return returns WeatherServiceImpl
     */
    @WebEndpoint(name = "WeatherServiceImplPort")
    public WeatherServiceImpl getWeatherServiceImplPort() {
        return super.getPort(new QName("http://service.mybatis.orm.xkcoding.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class);
    }
    ...
    public WeatherServiceImpl getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.mybatis.orm.xkcoding.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class, features);
    }
